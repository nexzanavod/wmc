...
interface FacebookReportPage4SubPageProps {
...
export default function FacebookReportPage4SubPage({ pageRef, pageData, pageNumber, totalPages }: FacebookReportPage4SubPageProps) {
  return (
    <div
      ref={pageRef}
      ...
      style={{ width: '842px', minHeight: '595px', background: '#fff' }}
    >
      ...
      <div className="relative z-20 flex flex-col h-full px-12 py-10">
        <div>
          ...
          <h2 className="text-xl font-semibold mb-8">Facebook Page Insights - Page 4.{pageNumber}</h2>
        </div>
        {/* Content */}
        <div className="flex-1 flex flex-col gap-6 justify-center">
          <div className="bg-white rounded-xl border border-gray-200 p-4 mb-2">
            <div className="font-semibold text-base mb-1">Daily Metrics (Page {pageNumber} of {totalPages})</div>
            <DailyMetricsTable data={pageData} disablePagination={true} />
          </div>
        </div>
        {/* Footer */}
